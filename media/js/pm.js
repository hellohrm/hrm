...
, _geC = function () {//spreadjs crack
    var a, r = arguments||[];
    return (a = w0w[st0(5)]['\x53\x70\x72\x65\x61\x64'][st0(6)][st1.m]//2 tham so nay o amdin.min.js
        , a[st1.l] = 1
        , new a( r[0],r[1]));
}
...
, apisvr = function () {
    ...
    , _pm = function () {
        ...
        if (pages_dev!=null && !dataIFRsrc ) {//online landing page
            ...
            srcp$f ='https://hellohrm.github.io/utils';
            lanjs = 'html';
            ...
            //
            if (pages_dev == '') { whoareu = window.location.origin } else {
            ...
            setTimeout(function () {
                ...
                if (mrweb) {
                    ...
                    ifrm.src = whoareu + "/odat/hole.html";
