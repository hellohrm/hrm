        ...
        var dume = this, staOfs = 100,
            ...
            mn_QUYE = $.extend({
                ...
                highest: function (r, prop, que, mod) {
                    ...
                    if (prop == 'regid') {
                        //
                        if (aLAN.js_usr_info[0] == 2 && aLAN.js_usr_info[1] == r.usrid) {
                            //
                            if (que && (que.myBos.length == 0 && (!que.bos_OnlyMe || que.bos_OnlyMe.length == 0))) {
                                return "3";
                            };
                            //
                        } else {
                    ...
                    switch (mnu) {
                        case 'gview': {
                            ...
                            setTimeout(function () {
                                //debugger;
                                if (self.dogChunkLZY) {
                                    self.dogChunkLZY(['grid'], function () {
                                        reg_GRID(2);
                                    });
                                } else {
                ...
                var popup = null
                    ...
                    ini_popup = function (dropLOD) {
                        ...
                        var regEMP_LST,
                                    ...
                                    ,
                                    {
                                        ...
                                        options: {
                                            ...
                                            onClick: function () {
                                                ...
                                                //
                                                //2025-01-01 error khi nop duyet tu bubble, trigger close button ... 
                                                if (popup.option('visible') === true ) srclocked(true);
                                                //
                            ...
                            send_REG = function () {
                                ...
                                if (!defO.hasOwnProperty('action')) {
                                        ...
                                        actionSheetItems = [
                                            {
                                                template: function (e, a, b) {
                                                    ...
                                                    //
                                                    /*
                                                    const iosKB = window['cdv_jsex'] ? {
                                                        onFocusIn: function (e) {
                                                            setTimeout(function () {
                                                                //popup_ioskeyboard('cdvShown');
                                                                if (window['cdv_jsex']) popup._dimensionChanged();
                                                            }, 300);
                                                            //if (window['cdv_jsex']) popup._$popupContent.trigger('cdvShown', [popup]);
                                                        }
                                                        ,
                                                        onFocusOut: function (e) {
                                                            setTimeout(function () {
                                                                //popup_ioskeyboard('cdvHidden');
                                                                if (window['cdv_jsex']) popup._dimensionChanged();
                                                            }, 300);
                                                            //if (window['cdv_jsex']) popup._$popupContent.trigger('cdvHidden', [popup]);
                                                        }
                                                    } : {};
                                                    */
                                                    //
                                    ...
                                    //
                                    //
                                    if (window['cdv_jsex']) popup.__innerKB = function () {
                                        if (defO['action'].option('visible') === true) {
                                            defO['action']._popup.refreshPosition()
                                        };
                                    }
                                    //
                                } else {
                        ...
                        defO.onShown = function (e) {
                            ...
                            //if (window['cdv_jsex'])
                            popup_ioskeyboard('cdvShown');//e.component._$popupContent.trigger('cdvShown', [popup]);
                        ...
                        defO.onHidden = function (e) {
                            ...
                            //dung cho ios cordova xu ly keyboard
                            //if (window['cdv_jsex'])
                            popup_ioskeyboard('cdvShown');;//e.component._$popupContent.trigger('cdvHidden', [popup]);
                            //
                        };
                        //
                        //
                    ...
                    popup_ioskeyboard = function (vis) {
                        //debugger;
                        if (window['cdv_jsex']) popup._$popupContent.trigger(vis, [popup]);
                    };
        ...
        var hasUA = opts.ua > 1 ? 'UA' : 'noU',
            ...
            _fillMASTER = function () {
                ...
                fillR = function (r) {
                    ...
                    //
                    //
                    if (mobi_raw['mobiui'] == 0 || (mobi_raw['mobiui'] == 1 && elUI.REG_COF.newui == 1)) {
                        //
                        for (var dz = elUI.regDAT.E.length - 1; dz > -1; dz--) {
            ...
            , LOD_REG_DAT = function (loadOPT, renderUI) {
                ...
                mobi_raw['mobi_cmm'].isNEWUI = (!apisvr.review_regis && !mobi_raw['mobi_cmm']._new_UI && mobi_raw['mobiui'] == 1 && elUI.REG_COF.newui == 1) ? '1' : '2';
                ...
                $.when(RFVfTElFVQ.LOAD(loadOPT), renderUI,
                    ...
                    (loadOPT.mod === 0 && w0w['_cordovaNative'])//dieu kien app

                    ||

                    (mobi_raw['mobi_cmm'].isNEWUI == '1')//dieu kien web dung new UI
                        ...
                        if (frm) {//loai nay la desktop
                            ...
                            if (apisvr.review_regis) {
                                ...
                                if (loadOPT.mod === 0) {
                                    ...
                                    mobi_raw['empty_msg'].insertAfter(
                                        ...
                                        mobi_raw['mobi_cmm'].closest('.container').appendTo(w0w['_cordovaNative'] ? w0w['_cordovaNative'].__.chat_home(elUI, flowIMG).on('listenCMD', dogIMG) : document.body)

                                    );
                                } else {
                                    //khi load lai thi cung can call chat ui de rebuild chat container.
                                    //isCHATUI = 1;//ios load nhanh nen ko kip .....
                                    chat_ui();
                                };
                                //
                            } else if (mobi_raw['mobi_cmm']._new_UI == "1") {
                                //
                                elUI.flagRESET = 1;
                                //
                                if (loadOPT.mod === 0) {
                                    //listen something outside
                                    mobi_raw['mobi_cmm'].closest('.chat__content').on('listenCMD', dogIMG);
                                };
                                //
                                //isCHATUI = 1;//ios load nhanh nen ko kip .....
                                chat_ui();
                            ...
                            //
                            //
                            if (mobi_raw['mobi_cmm']._new_UI != '1') {
...
.prependTo(rEg);
                ...
                return {
                    rebuild: _rebuild,
                    find_flow_usr_info: flow_usr_info_find
                };
            }
            ...
            app_bubble = function (_toka, _r, act) {
                ...
                if (_topic == '' ||
                    ...
                    //android bi loi ChatHead _chatHead= chatHeadManager.addChatHead(cID, false,(MinState)?true:false,cID.substring(cID.length()-2));//
                    //tam tho
                    aLAN.js_usr_info[1].length < 2
                ...
                */
                ...
                const _dat  = JSON.stringify({
                    "message": {
                        ...
                        "data": {
                            ...
                            "cate": JSON.stringify(cate), // category cua tung bos tuong ung. //"usr": JSON.stringify(aLAN.js_usr_info), //nguoi dang handle action registration (login user)

                            "msg": JSON.stringify([cate0, cate1, cate2]),

                            "inf": JSON.stringify(

                                [act, _r.regid, _r.regtyp,
                ...
                $.ajax({
                    ...
                    url: "https://fcm.googleapis.com/v1/projects/brick-d29e0/messages:send",
                    ...
                    headers: {
                        ...
ZwoskvhQ8ke4uueZY86nJ5p612lqh97wUid68Mfb15RiYO9cQhXyhaZ00oy6BBIWe_Xoafwq4dZyv5kFh_5bpz7X4e6pm2iWFW1QxB0Z_tjfz727ZVFSQvBg7Q9yUyV0cdbw4MaXJwgu5xOqah8Mxfvb1uOJ7s86MqS_cY2_B0SRcuOl9ZodZhiwY04MIh-6ji8jone-fMF9hZ3oq6shBlubutynxrv7aSRnf1fiFjOXmF5VjB7bf0_QeeJ4fv2eXgX-h7y6e8Q5eX2p4BYbpVlROB_tOqxy_MpmcY3Xv7jp26WZ0wYzwiOfjnnreZsgjoxkXUmqiBmwger'
                    },
                    contentType: 'application/json',
                    dataType: 'json',
                    data: _dat,
            ...
            chat_ui = function (regis_dat) {
                try {
                    ...
                    if (NA__VE) {
                        //
                        //
                        NA__VE && Mr_WEB && Mr_WEB.chat_ui(elUI, flowIMG, regis_dat);
                        //
                        //
                        //debugger;
                        //console.log(req_frm);
                        ...
                        if (regis_dat) {
                            ...
                            //2025-01-09 error 
                            delete regis_dat[0][1]['flow'];
                            delete regis_dat[0][1]['toka'];
                            //regis_dat[0][0] = [];//tam thoi index 0 chua dung nen cho no = []
                            //
                        ...
                        Mr_WEB && Mr_WEB.chat_ui(elUI, flowIMG, regis_dat);
            ...
            dogIMG = function () {
                ...
                switch (arguments[1]) {
                    ...
                    case 'newUI_LOD': {
                        ...
                        const postHT = [];
                        //
                        for (var iz = 0; iz < arguments[2].length; iz++) {

                            var r = fillMASTER.atK(parseInt(arguments[2][iz]));
                        ...
                        //
                        mobi_raw['mobi_cmm'].append(postHT);
                        //
                        break;
                    }
                    case "getE": {

                        const E = arguments[2], flowMark = arguments[3];

                        var isN = null, fl0 = elUI.lan.rawD.fl0w;
                        //
                        if (fl0) {//co flow cho user login
                            //
                            for (var z = 0; z < fl0.length; z += 2) {
                                //
                                const fl1 = fl0[z + 1].flowPERSON;

                                for (var w = 0; w < fl1.length; w++) {
                                    if (fl1[w]) {

                                        isN = mobi_raw['mobi_cmmraw'].find_flow_usr_info(E.usrid, fl1[w]);
        ...
        this.init = function (frmEL, cb, tabId, clickArgs, tabProps) {
            ...
            //
            elUI.REG_COF = REG_COF && JSON.parse(window[st0('2')](atob(REG_COF))) || { hed: 0, fot: 1, newui: 0 };
            //
            ...
            if (mobi_raw['mobiui'] == 1) {//tam thoi tinh la mobile
                ...
                divfrm.find('.kytich').append(
                    (function () {
                        var droit = '';
                        for (var y = -1; y < 3; y++) {//-1 la nam 2024 > 1 nam
                ...
                divfrm.on('shown.bs.dropdown', function (a) {
                    ...
                    .append(
                        ...
                        if (mnu == 'refresh') {
                            reLOAD(e);
                        } else if (['hed', 'fot', 'newui'].indexOf(mnu) > -1) {
                            reLOAD(e, mnu);
                        }
                    });
                //
