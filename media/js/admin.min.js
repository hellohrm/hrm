var dopostqueue = {}, helloguy, db_dat = ['attunits', 'hols', 'ots']
 ...
 , admin$ = function () {
     ...
     , svrDAT = function (pArgs) {
         ...
         w0w.apisvr.ajax($.extend({}, { 'ajaxsession': ajaxsession, 'auri': encodeURIComponent(window.location.href), 'basejs': [w0w.tabglobalJS.hasOwnProperty('JS_' + pArgs.tabId), window.dynload.indexOf(pArgs.tabId + '.js')], 'iwkfhtbz': w0w.apisvr.a$.iwkfhtbz, 'selected_language': w0w.apisvr.a$.selected_language, 'masterdat': !masterdat ? '1' : '0' }, pArgs));
         ...
         if (window.DevExpress) {
             ...
             setTimeout(function () {
                 ...
                 var loc = apisvr.a$.selected_language, devjs = function () {
                     w0w['_gsC']('https://cdn3.devexpress.com/jslib/' + deV.v + '/js/dx.web.js', 'js', function () {//'/media/dx.web.debug.js'//'https://cdn3.devexpress.com/jslib/20.1.3/js/dx.all.js',
                         //
                         if (loc == 'vi') {
                     ...
                     w0w['_gsC']('https://cdnjs.cloudflare.com/ajax/libs/cldrjs/0.5.1/cldr.min.js', 'js', function () {
                         w0w['_gsC']('https://cdnjs.cloudflare.com/ajax/libs/cldrjs/0.5.1/cldr/event.min.js', 'js', function () {
                             w0w['_gsC']('https://cdnjs.cloudflare.com/ajax/libs/cldrjs/0.5.1/cldr/supplemental.min.js', 'js', function () {
                                 w0w['_gsC']('https://cdnjs.cloudflare.com/ajax/libs/globalize/1.6.0/globalize.min.js', 'js', function () {
                                     w0w['_gsC']('https://cdnjs.cloudflare.com/ajax/libs/globalize/1.6.0/globalize/message.min.js', 'js', function () {
                                         w0w['_gsC']('https://cdnjs.cloudflare.com/ajax/libs/globalize/1.6.0/globalize/number.min.js', 'js', function () {
                                             w0w['_gsC']('https://cdnjs.cloudflare.com/ajax/libs/globalize/1.6.0/globalize/currency.min.js', 'js', function () {
                                                 w0w['_gsC']('https://cdnjs.cloudflare.com/ajax/libs/globalize/1.6.0/globalize/date.min.js', 'js', function () {
     ...
     , chromeTabs, navbar_right, resizeTimeout, isLogout = false
         ...
         , chromeTAB = function () {
             ...
             elTAB[0].addEventListener('tabRemove', function (detail) {
                 ...
                 //
                 w0w.app_container.find('#tabBODY_' + tabId + ',#tabBODY_' + tabId + ' *').unbind().removeData();
                 tab.remove();
                 //
                 valid_TAB();
             });
         ...
         , tabBODY = function (tabhead) {
                 ...
                 $.when(def1, def2, jsEX).then(function (v1) {
                     var newFRM = $("<div id='tabBODY_" + tabId + "' class='noneifrm'></div"),
                         newT = function (a, b, c) {
                             ...
                             //};
                             w0w.app_container.append(newFRM).ready(function () {
                                 //
             ...
             if (tabProps.tabtype == 'ifrm') {
                 ...
                 var jsCSS = function () {
                     w0w['_gsC'](srcpf$ + '/media/css/JS_' + tabId + '.css', 'css', function () { }, 'JS_' + tabId + '.css');
                     w0w['_gsC'](srcpf$ + '/media/js/JS_' + tabId + '.js', 'js', function () { def3.resolve('def3'); }, 'JS_' + tabId + '.js');
                 };
