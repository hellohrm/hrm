    ...
    (function () {
        _gsC('https://cdn.jsdelivr.net/npm/sweetalert2@10/dist/sweetalert2.min.js', 'js', function () {
            _gsC('https://cdn.jsdelivr.net/npm/sweetalert2@10/dist/sweetalert2.min.css', 'css', function () {
                ...
                var lan=JSON.parse(atob(""));
                ...
                window.dupHELLO = function (mor, cb) {//call in sockjo.js
                    ...
                    if (mor) {
                        ...
                        if (mor.txt) {
                            ...
                            defO.text = _gLA(mor.txt) || (mor.txt == 'js_regis' ? 'Registration is no longer available, please search deeply in the Database ...' : '');

                            delete mor.txt;//xoa bo
                        };
                    ...
                    Swal.fire(defO).then(function (result) {
                        ...
                        if (!result.isConfirmed) {
                            setTimeout(function () {
                                //
                                if (!mor) {
                                    var ww = window.open('https://hrm.dnd.vn/chamcong', '_self');
                                };
                                //
